...
class Nonogram():
    def __init__(self, scale, hardship= 0.3):
        ...
        self.allpoints = dict() # All Points With It's Values -> {(Column_Number1, Row_Number1): Value, Point2: Value, ...}
        self.allpointslist = [] # List Of All Points -> [ (Column_Number1, Row_Number1), point2, point3,....]
        self.Nonepoints = [] # List Of All Points Which It's Values Is 'None'
        self.truePoints = [] # List Of All Points Which It's Values Is 'True'
        self.helpcolumns, self.helprows = dict(), dict() # All Column & Row Guides -> {Column Or Row Point: Guide List}
